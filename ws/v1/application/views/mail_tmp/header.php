            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <table style="border-left:thin #2A7271 solid; border-right:thin #2A7271 solid; border-bottom:6px #2A7271 solid;border-top:thin #2A7271 solid;" width="580" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            <tbody>
                                <tr>
                                    <td>
                                        <!-- logo -->
                                                ...
                                                <tr>
                                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                                        <div class="imgpop">
                                                            ...
                                                            </div> <a href="#"><img src="<?= str_replace('/ws/'.APP_VERSION,'',site_url('logo.png')) ?>" width="100" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="logo" /></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
