...
{
    // default connection
    public static $dbname = 'indiapap_order'; // Your database name
    public static $dbuser = 'indiapap_root'; // Your database username
    public static $dbpass = 'order@12345'; // // Your database password
//    public static $dbpass = ''; // // Your database password
   ...
   // theme and language
    ...
    public static $limit_list = array('50', '100', 'all'); // default limits list
